...
SECRET_KEY = 'django-insecure-gu7rt*8q7n6l0pdo7rxij61%@%=_a^%-8ooq%de#zr*was5*3)'
...
LOGIN_URL = reverse_lazy("book_app:main")

LOGIN_REDIRECT_URL = "/shop"
LOGOUT_REDIRECT_URL = reverse_lazy("book_app:main")
